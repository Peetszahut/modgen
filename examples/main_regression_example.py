...
train = pd.read_csv(path + "train.csv", nrows = 100_000)
...
# Credit: DJ Sterling - Kernel: NYC Taxi Fare Starter Kernel - Simple Linear Model
...
if use_previous_model:
    params, model_selector, model_selector_mod = getSavedParams(path, load_index = 18)
